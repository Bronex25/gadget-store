...
import { addToCard, toggleFavorites } from '../../features/productSlice';
...
export const ProductCard: React.FC<Props> = ({ product }) => {
  const favoriteItems = useAppSelector(state => state.product.favoritesItems)
    ...
    <article className={styles.card}>
      <Link to={`/phones/${product.itemId}`} className={styles.cardLink}>
        ...
        <div className={styles.controls}>
          ...
          <button
            className={cn(styles.favoriteButton, { [styles['favoriteButton--active']]: containItem })}
